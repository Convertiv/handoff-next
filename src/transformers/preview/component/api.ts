...
export const readComponentMetadataApi = async (handoff: Handoff, id: string): Promise<ComponentListObject | null> => {
  ...
  return {
    ...
    figmaPublishedComponentKeys: componentData.figmaPublishedComponentKeys,
    figmaFileKey: componentData.figmaFileKey,
    figmaNodeId: componentData.figmaNodeId,
    figmaComponentSetId: componentData.figmaComponentSetId,
    figmaComponentSetName: componentData.figmaComponentSetName,
    figmaComponentName: componentData.figmaComponentName,
    figmaDescription: componentData.figmaDescription,
    figmaThumbnailUrl: componentData.figmaThumbnailUrl,
    figmaUpdatedAt: componentData.figmaUpdatedAt,
    figmaVariantSchema: componentData.figmaVariantSchema,
    figmaVariantLabel: componentData.figmaVariantLabel,
    figmaVariantValues: componentData.figmaVariantValues,
    figmaInstanceCount: componentData.figmaInstanceCount,
    figmaImages: componentData.figmaImages,
    figmaMatchStatus: componentData.figmaMatchStatus,
    figmaMatchedBy: componentData.figmaMatchedBy,
    figmaMissingMetadata: componentData.figmaMissingMetadata,
