...
import { DESIGN_IMAGE_MODEL, clearApiKey, getApiKey, setApiKey } from './llm-client';
      ...
      {hasKey ? (
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Design will use <code className="rounded bg-muted px-1 py-0.5 text-xs">{DESIGN_IMAGE_MODEL}</code>.
          </p>
        ...
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Enter your OpenAI API key to use Design with{' '}
            <code className="rounded bg-muted px-1 py-0.5 text-xs">{DESIGN_IMAGE_MODEL}</code>.
          </p>
          <div className="space-y-1.5">
            <Label htmlFor="design-api-key-input">OpenAI API Key</Label>
            <div className="flex gap-2">
              <Input
                id="design-api-key-input"
                type="password"
                placeholder="sk-..."
                value={key}
