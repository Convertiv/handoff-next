...
export default function IconsPageClient({ content, menu, metadata, current, config, assets }) {
  ...
  return (
    <Layout config={config} menu={menu} current={current} metadata={metadata}>
      ...
      <Input type="text" placeholder="Search icons..." onChange={filterList} onKeyDown={handleKeyDown} value={search} ref={inputRef} className="px-5 py-6 text-lg" />
