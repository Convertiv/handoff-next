    ...
    <Layout config={config} menu={menu} current={current} metadata={metadata} fullWidthHero={true}>
      ...
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 gap-6 pb-16 md:grid-cols-3">
          ...
          <Link href="/foundations/colors" className="group mt-2 transition-colors dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900">
            <div className="flex flex-col items-start gap-2">
              <div className="mb-3 flex max-h-48 w-full items-center justify-center overflow-hidden rounded-md bg-gray-100 dark:bg-gray-900">
                <Image src={`${process.env.HANDOFF_APP_BASE_PATH ?? ''}/assets/images/colors.svg`} alt="Colors" width={327} height={220} />
              </div>
              <h3 className="text-base font-medium">Colors</h3>
              <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">Official color palette used for all digital products.</p>
          ...
          <Link href="/foundations/typography" className="group mt-2 transition-colors dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900">
            <div className="flex flex-col items-start gap-2">
              <div className="mb-3 flex max-h-48 w-full items-center justify-center overflow-hidden rounded-md bg-gray-100 dark:bg-gray-900">
                <Image src={`${process.env.HANDOFF_APP_BASE_PATH ?? ''}/assets/images/typography.svg`} alt="Typography" width={327} height={220} />
              </div>
              <h3 className="text-base font-medium">Typography</h3>
              <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">Official typography system used for all digital products.</p>
              <Button variant="link" className="px-0 text-sm font-medium text-gray-900 hover:no-underline dark:text-gray-100">
                View Typography
                <ArrowRight className="inline-block transition-transform group-hover:translate-x-1" />
              </Button>
      ...
      <div className="container mx-auto px-8 pt-16">
        <div className="grid grid-cols-1 gap-6 pb-16 md:grid-cols-3">
          ...
          <Link href="/system" className="group mt-2 transition-colors dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900">
            <div className="flex flex-col items-start gap-2">
              <div className="mb-3 flex max-h-48 w-full items-center justify-center overflow-hidden rounded-md bg-gray-100 dark:bg-gray-900">
          ...
          <Link href="/system" className="group mt-2 transition-colors dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900">
            <div className="flex flex-col items-start gap-2">
              <div className="mb-3 flex max-h-48 w-full items-center justify-center overflow-hidden rounded-md bg-gray-100 dark:bg-gray-900">
                <Image src={`${process.env.HANDOFF_APP_BASE_PATH ?? ''}/assets/images/blocks.svg`} alt="Colors" width={327} height={220} />
              </div>
